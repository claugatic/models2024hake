...
savePlot(filename = "run1/f1.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
p.biom.stk(dat=data1,typ="SSB")
savePlot(filename = "run1/f2.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
p.biom.stk(dat=data1,typ="TB")
savePlot(filename = "run1/f3.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# fit index
p.sur.stk(dat=data1,f=1,ylab="Index", yf=1992,yl=2023)
savePlot(filename = "run1/f4.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# fit cathc
p.catch.fit(dat=data1,f=1,ylab="Catch biomass (kt)" )
savePlot(filename = "run1/f5.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# fit index
IndexFit(dat=data1)
savePlot(filename = "run1/f6.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# CAA fit
AgeFits(dat=data1,case_label="2012 assessment",f=1,lyr=1992,lage=2,hage=12)
savePlot(filename = "run1/f7.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# CAA survey
AgeFitsSrv(dat=data1, main="",case_label="2023 assessment",lyr=1992,lage=2,hage=12,f=1,rec_age=2)
savePlot(filename = "run1/f8.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Grafico contorno de F
cont.f.mort(dat=data1,f=1,lage=2,hage=12,cl="BW") ## data file, fishery, lowest and highest ages
savePlot(filename = "run1/f9.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Burbujas NAA. CAA. BAA.
p.bub.age(dat=data1,typ="NA",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=500000)     # NAA
savePlot(filename = "run1/f10.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
p.bub.age(dat=data1,typ="CB",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=20000) 		# CAA
savePlot(filename = "run1/f11.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
p.bub.age(dat=data1,typ="B",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=55000)		# BAA
savePlot(filename = "run1/f12.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# NAA. CAA. BAA con F 
cont.f.mort2(dat=data1,typ="NA",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=500000,cl="BW")
savePlot(filename = "run1/f13.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
cont.f.mort2(dat=data1,typ="CB",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=20000,cl="BW")
savePlot(filename = "run1/f14.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
cont.f.mort2(dat=data1,typ="B",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=200000,cl="BW")
savePlot(filename = "run1/f15.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Edad Media
p.eff.n(dat=data1,typ="S",f=1) 	# crucero
savePlot(filename = "run1/f16.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
p.eff.n(dat=data1,typ="F",f=1)	# Pesqueria
savePlot(filename = "run1/f17.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Select a la edad
p.select.hist(dat=data1,typ="F",h="T",f=1,lage=2,hage=12,fy=1992,ly=2012)   # Select barr
savePlot(filename = "run1/f18.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

c.select(dat=data1,typ="F",f=1,lage=2,hage=12,fy=1992,ly=2023,cl="BW")		# Select F
savePlot(filename = "run1/f19.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

c.select(dat=data1,typ="S",f=1,lage=2,hage=12,fy=1992,ly=2023,cl="BW")      # Select Survey
savePlot(filename = "run1/f20.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
...
savePlot(filename = "run1/f21.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Survey selectivity
p.survey.curve(dat=data1,f=1,lage=2,hage=12)
savePlot(filename = "run1/f22.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# SSB with error bar
p.biom.pol(dat1=data1, dat2=data1, n.mod=1, typ="SSB",color=c("light blue", 'darkblue', 'light green', 'darkgreen'), new=TRUE)
savePlot(filename = "run1/f23.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# R with error bar
p.biom.pol(dat1=data1, dat2=data1, n.mod=1, typ="R",color=c("light blue", 'darkblue', 'light green', 'darkgreen'), new=TRUE)
savePlot(filename = "run1/f24.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# TB with error bar
p.biom.pol(dat1=data1, dat2=data1, n.mod=1, typ="TB",color=c("light blue", 'darkblue', 'light green', 'darkgreen'), new=TRUE)
savePlot(filename = "run1/f25.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
...
savePlot(filename = "run1/f26.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
...
savePlot(filename = "run1/f27.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# shawdow the biomass
cont.CB_TB(dat=data1,mod="1",f=1,f1=1,lage=2,hage=12,fy=1992,ly=2023,siz=2000000,cl="BW",ncol1=100,maxb=33000)
savePlot(filename = "run1/f28.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Residuales del modelo
bp.f.age.res(dat=data1,mod="1",typ="S",f=1,f1=1,lage=2,hage=12,siz=1) # Survey
savePlot(filename = "run1/f29.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

bp.f.age.res(dat=data1,mod="1",typ="F",f=1,f1=1,lage=2,hage=12,siz=1) # fishery
savePlot(filename = "run1/f30.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

#Mortalidades por pesca
cont.f.mort3(dat=data1,typ="CB",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=20000,cl="CL")
savePlot(filename = "run1/f31.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

cont.f.mort3(dat=data1,typ="B",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=200000,cl="CL")
savePlot(filename = "run1/f32.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# CAA and B with Selectiviy
c.select.b2(dat=data1,typ="F",typ2="CB",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=20000,cl="BW")
savePlot(filename = "run1/f33.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

c.select.b2(dat=data1,typ="F",typ2="B",f=1,lage=2,hage=12,fy=1992,ly=2023,siz=200000,cl="BW")
savePlot(filename = "run1/f34.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# Proyecciones
plot_FCATCH()
savePlot(filename = "run1/f35.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
plot_FSSB()
savePlot(filename = "run1/f36.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

FutBiom(dat=data1, new=TRUE,ylab="Female SSB(kt)",fy=1992,ly=2027,nproj=5)
savePlot(filename = "run1/f37.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

FutCatch(dat=data1,fy=1992,ly=2053) #42
savePlot(filename = "run1/f38.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)

# razon de biomasa
spwn_ratio (dat=data1)
savePlot(filename = "run1/f39.pdf",type = c("pdf"),device = dev.cur(),restoreConsole = TRUE)
